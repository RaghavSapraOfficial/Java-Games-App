...
class GamePage extends JFrame implements ActionListener {
    ...
    GamePage() {
        ...
        // heading section
        // Heading.setIcon(new ImageIcon("game-logo.jpeg"));
        ...
        // thdButton properties
        thdButton.setText("THIRD");
        thdButton.setFocusable(false);
        thdButton.setVisible(true);
        thdButton.setBounds(73, 360, 150, 50);
        thdButton.setForeground(Color.RED);
        thdButton.setBackground(Color.BLACK);
        thdButton.addActionListener(this);

        // exitButton properties
        exitButton.setText("EXIT");
        exitButton.setFocusable(false);
        exitButton.setVisible(true);
        exitButton.setBounds(250, 360, 150, 50);
...
class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            ...
            g.drawString("Score: " + applesEaten, ((SCREEN_WIDTH / 2) - (metrics.stringWidth("Game Over")) / 2),
                    g.getFont().getSize());
        } else {
            gameOver(g);
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + applesEaten, ((SCREEN_WIDTH / 2) - (metrics1.stringWidth("Game Over")) / 2),
                g.getFont().getSize());
        g.setColor(Color.red);
